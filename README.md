...
1. **Create a Category**:
   - Switch to the Categories tab using the bottom navigation bar.
   - Click on the `+` button.
   - Enter a name for the category.
   - Search for an icon and choose a color for the icon.

2. **Create a Task**:
   - Switch to the Tasks tab using the bottom navigation bar.
   - Click on the `+` button to create a new task.
   - Enter the task details, set a deadline, and assign the task to a category.

3. **Manage Tasks**:
   - View tasks ordered by their deadlines.
